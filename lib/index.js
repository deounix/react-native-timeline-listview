...
const defaultDescriptionColor = "grey";
const defaultTimeBackgroundColor = "#ff9797";
const defaultScoreColor = "grey";
...
export default class Timeline extends Component {
  ...
  _renderTime(rowData, sectionID, rowID) {
    var timeBackgroundColor = rowData.timeBackgroundColor
      ? rowData.timeBackgroundColor
      : this.props.timeBackgroundColor
      ? this.props.timeBackgroundColor
      : defaultTimeBackgroundColor;
  ...
  _renderDetail(rowData, sectionID, rowID) {
    var titleColor = rowData.titleColor
      ? rowData.titleColor
      : this.props.titleColor
      ? this.props.titleColor
      : defaultTitleColor;
    var descriptionColor = rowData.descriptionColor
      ? rowData.descriptionColor
      : this.props.descriptionColor
      ? this.props.descriptionColor
      : defaultDescriptionColor;
    var scoreColor = rowData.scoreColor
      ? rowData.scoreColor
      : this.props.scoreColor
      ? this.props.scoreColor
      : defaultScoreColor;

    let title = rowData.description ? (
      <View style={{ marginLeft: 15, marginTop: -8.5 }}>
        <Text
          style={[styles.title, this.props.titleStyle, { color: titleColor }]}
        >
          {rowData.title}
        </Text>
        <Text
    ...
    return (
      <View style={[styles.container, { color: titleColor }]}>{title}</View>
    );
  }
